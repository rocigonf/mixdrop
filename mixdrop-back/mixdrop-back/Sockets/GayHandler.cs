...
public class GayHandler // GameHandler :3
{
    ...
    public readonly Dictionary<object, object> _participants = new Dictionary<object, object>(); // Guarda los usuarios y sus cartas
    public int _timmyTurnerId = 0; // Id del usuario que tiene el turno
